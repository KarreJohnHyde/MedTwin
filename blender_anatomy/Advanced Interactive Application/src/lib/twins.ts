...
export const ORGAN_REGISTRY = {
  ...
  lungs: {
    ...
    accent: "#38bdf8",
    glb: { high: "/assets/lungs_-_normal_study.glb", medium: "/assets/lungs_-_normal_study.glb", low: null },
    anchors: [],
  ...
  skeleton: {
    ...
    bodySystem: "skeletal",
    accent: "#fbbf24",
    glb: { high: "/assets/male_human_skeleton_-_zbrush_-_anatomy_study.glb", medium: "/assets/male_human_skeleton_-_zbrush_-_anatomy_study.glb", low: null },
    anchors: [],
